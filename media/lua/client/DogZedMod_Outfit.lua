...
DogZedMod.outfit1 = "ShadowDog_1"
DogZedMod.outfit2 = "ShadowDog_2"
...
function DogZedMod.getOutfitName(zed)
	...
	if fit == DogZedMod.outfit1 then return "ShadowDog_1" end
	if fit == DogZedMod.outfit2 then return "ShadowDog_2" end
	return nil
end
